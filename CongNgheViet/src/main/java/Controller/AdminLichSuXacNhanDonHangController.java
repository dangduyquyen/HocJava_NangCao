...
/**
 * Servlet implementation class AdminLichSuXacNhanDonHangController
 */
@WebServlet("/AdminLichSuXacNhanDonHangController")
public class AdminLichSuXacNhanDonHangController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminLichSuXacNhanDonHangController() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("LichSuXacNhanDonHang.jsp");
